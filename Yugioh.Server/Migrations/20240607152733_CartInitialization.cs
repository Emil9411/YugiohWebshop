...
{
    /// <inheritdoc />
    public partial class CartInitialization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_MonsterCards_ProductId",
                        column: x => x.ProductId,
                        principalTable: "MonsterCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_SpellAndTrapCards_ProductId",
                        column: x => x.ProductId,
                        principalTable: "SpellAndTrapCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
